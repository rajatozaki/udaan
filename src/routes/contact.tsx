  ...
  return (
    ...
    >
      ...
      <g transform="translate(380, 130)" opacity="0.75">
        ...
        {/* Origami Crane in Stamp */}
        <g transform="translate(48, 38) scale(0.5)">
          <polygon points="24,18 42,4 34,22" fill="#d97706" fillOpacity="0.4" stroke="#b45309" strokeWidth="1.2" />
          <polygon points="24,18 6,6 16,22" fill="#f59e0b" fillOpacity="0.5" stroke="#d97706" strokeWidth="1.2" />
          <polygon points="24,18 34,22 22,32 16,22" fill="#b45309" fillOpacity="0.3" stroke="#92400e" strokeWidth="1.2" />
        </g>
        ...
        <div className="site-wrap-wide grid gap-12 md:grid-cols-12 md:gap-16">
          <div className="md:col-span-5">
            ...
            <div className="mt-8 space-y-4">
              <a
                href={SITE.phoneHref}
                className="flex items-center gap-3 rounded-2xl border border-amber-900/15 paper-card p-4 font-semibold text-[#221610] shadow-xs transition-all hover:border-amber-500 hover:bg-amber-50/20"
              >
            ...
            <div className="mt-12 space-y-8">
              {PLANTS.map((plant) => (
                <div
                  key={plant.id}
                  className="overflow-hidden rounded-3xl border border-amber-900/15 paper-card p-5 shadow-sm transition-all hover:border-amber-500/50"
                >
          ...
          <Reveal className="relative overflow-hidden rounded-3xl border border-amber-900/15 paper-card p-8 shadow-2xl md:col-span-7 md:p-12">
            {/* Corner Decorative Watermark */}
            <div className="absolute top-4 right-4 text-xs font-mono text-amber-800/40 tracking-widest uppercase">
              Doc · RFQ-01
            </div>

            {sent ? (
              <div className="flex min-h-96 flex-col justify-center text-center">
                <div className="mx-auto mb-4 flex size-14 items-center justify-center rounded-2xl bg-amber-100 text-amber-700 font-bold text-xl">
                  ✓
                </div>
                <span className="mono-spec inline-block text-xs font-bold text-amber-700">
                  Received
                </span>
              ...
              <form className="grid gap-5 sm:grid-cols-2" onSubmit={onSubmit}>
                ...
                <label className="block sm:col-span-2">
                  <span className="mono-spec mb-2 block text-xs font-semibold text-[#5c4a3e]">
                    Industry
                  </span>
                  <select
                    name="industry"
                    className="field-input text-[#221610] bg-[#fdfbf7] border-amber-900/20 focus:border-amber-600 focus:ring-amber-500/20"
                    defaultValue=""
                  >
